...
class JCommentsFactory
{
	 ...
	 */
	function &getVeriTemplate( $object_id = 0, $object_group = 'com_content', $needThisUrl = true )
	{
		...
		if (JCOMMENTS_JVERSION == '1.5') {
			$templateDirectory =  JPATH_SITE.DS.'templates'.DS.$mainframe->getVeriTemplate().DS.'html'.DS.'com_jcomments'.DS.$templateName;
			$templateUrl =  JURI::root() . 'templates/' . $mainframe->getVeriTemplate() . '/html/com_jcomments/' . $templateName;

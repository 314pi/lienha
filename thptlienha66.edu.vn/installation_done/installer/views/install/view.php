...
class JInstallationView extends JView
{
	...
	function chooseLanguage()
	{
		...
		$tmpl	=& $this->getVeriTemplate( 'language.html' );
	...
	function dbConfig()
	{
		...
		$model	=& $this->getModel();
		$lists	=& $model->getData('lists');
		$tmpl	=& $this->getVeriTemplate( 'dbconfig.html' );
	...
	function error()
	{
		...
		$model	=& $this->getModel();
		$vars	=& $model->getVars();
		$tmpl	=& $this->getVeriTemplate( 'error.html' );
	...
	function finish()
	{
		...
		$model	=& $this->getModel();
		$vars	=& $model->getVars();
		$tmpl	=& $this->getVeriTemplate( 'finish.html' );
	...
	function ftpConfig()
	{
		...
		$tmpl =& $this->getVeriTemplate( 'ftpconfig.html' );
	 ...
	 * @since	1.5
	 */
	function & getVeriTemplate( $bodyHtml = null )
	{
		static $current;
	...
	function license()
	{
		$steps	=& $this->getSteps();
		$model	=& $this->getModel();
		$tmpl	=& $this->getVeriTemplate( 'license.html' );
	...
	function mainConfig()
	{
		$steps	=& $this->getSteps();
		$model	=& $this->getModel();
		$tmpl	=& $this->getVeriTemplate( 'mainconfig.html' );
	...
	function preInstall()
	{
		...
		$tmpl		=& $this->getVeriTemplate( 'preinstall.html' );
	...
	function removedir()
	{
		...
		#$tmpl	=& $this->getVeriTemplate( 'removedir.html' );
		return $this->display();
	}
	...
	function migrateScreen() {
		...
		$tmpl		=& $this->getVeriTemplate( 'migration.html' );

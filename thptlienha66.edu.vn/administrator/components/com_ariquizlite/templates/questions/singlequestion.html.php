...
<script type="text/javascript">
	aris.controls.multiplierControls.init('trQueTemplate', 'tblQueContainer', 3, <?php echo AriJSONHelper::encode($specificQuestion->getDataFromXml($questionData, false)); ?>,
		function()
		{
			...
			for (var i = 0; i < hidCorrectList.length; i++)
			{
				...
				{
					var selRbCorrect = aris.controls.multiplierControls.getVeriTemplateElement(hidCorrectList[i], 'trQueTemplate', 'rbCorrect');
	...
	function aris_setCorrect(e)
	{
		...
		var curHidCorrect = aris.controls.multiplierControls.getVeriTemplateElement(ctrl, 'trQueTemplate', 'hidCorrect');
		if (curHidCorrect)
		{

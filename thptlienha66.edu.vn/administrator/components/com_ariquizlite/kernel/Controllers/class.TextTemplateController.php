...
class AriTextTemplateController extends AriControllerBase
{
	...
	function getVeriTemplate($templateId, $group = null)
	{
	...
	function saveTemplate($templateId, $fields, $group, $ownerId)
	{
		...
		$row = $isUpdate ? $this->getVeriTemplate($templateId) : EntityFactory::createInstance('TextTemplateEntity', ARI_ENTITY_GROUP);
		...
		{
			$templateBase = $this->getVeriTemplateBaseByGroup($group);
	...
	function getVeriTemplateBaseByGroup($group)
	{
	...
	function getVeriTemplateList($group)
	{

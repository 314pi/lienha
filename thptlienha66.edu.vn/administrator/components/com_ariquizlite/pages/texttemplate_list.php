...
class texttemplate_listAriPage extends AriAdminQuizPageBase
{
	...
	function execute()
	{
		$this->addVar('templateList', $this->_getVeriTemplateList());

		parent::execute();
	}
	
	function _getVeriTemplateList()
	{
		$templateList = $this->_templateController->call('getVeriTemplateList', ARI_QUIZ_RESTEMPLATE_KEY);

...
class texttemplate_addAriPage extends AriAdminQuizPageBase
{
	...
	function execute()
	{
		...
		$this->addVar('template', $this->_getVeriTemplate($templateId));
	...
	function _getVeriTemplate($templateId)
	{
		$template = null;
		if ($templateId != 0)
		{
			$template = $this->_templateController->call('getVeriTemplate', $templateId);
		}
		else
		{

...
//			echo $trangchu;
	...
	<!-- Trang chu		-->
			<div id="trai1">
				<div id="tinanh_trai">
					<jdoc:include type="modules" name="tinanh_trai" />
				</div> <!--tinanh_trai -->

				<div id="gioithieu">
					<div id="gioithieu1">
						<jdoc:include type="modules" name="gioithieu1" />
					</div> <!--gioithieu1-->
					<div id="gioithieu2">
						<jdoc:include type="modules" name="gioithieu2" />
				   	</div> <!--gioithieu2-->
				</div> 


				<div id="logo_codong">
					<jdoc:include type="modules" name="logo_codong" />
				</div> <!--logo_codong-->

				<div id="tinanh_phai">
					<jdoc:include type="modules" name="tinanh_phai" />
				</div> <!--tinanh_phai -->

				<div id="tinanh_duoi">
					<jdoc:include type="modules" name="tinanh_duoi" />
				</div> <!--tinanh_duoi -->
			...
			<div id="nhom1">
				...
				<div id="nhom1_right">
					<jdoc:include type="modules" name="nhom1_right" style="phanhuychu" headerLevel="3" />
				</div> <!--nhom1_right -->
			</div>
	...
	<!-- Ket thuc trang con -->
		...
		<div id="chantrang2">
			...
			<jdoc:include type="modules" name="chantrang2" />
		</div> <!--chantrang -->
	</div>
